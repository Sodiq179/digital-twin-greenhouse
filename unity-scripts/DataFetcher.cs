...
{
    public string baseUrl = "http://52.55.28.0:4000"; // Replace with your actual base URL
    public string endpoint = "sensors/sensor_data/2020/2"; // Replace with your actual endpoint
